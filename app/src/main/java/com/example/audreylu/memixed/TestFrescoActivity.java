...
/**
 * Created by audreylu on 2016/1/5.
 */
public class TestFrescoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaselineJpegView.setImageURI(Uri.parse("http://pic36.nipic.com/20131224/8803505_155014514000_2.jpg"));
        ...
        DraweeController animatedGifController = Fresco.newDraweeControllerBuilder()
                ...
                .setUri(Uri.parse("http://comic.qq.com/images/comic/2010/03/23/mc/3.gif"))
                .build();
